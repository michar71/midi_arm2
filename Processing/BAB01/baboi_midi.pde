...
public void send_midi()
{
  ...
  if (bpr.ctension_ch1 != -1)
  {
    ControlChange change = new ControlChange(0, 9, bpr.ctension_ch1/2);
    myBus.sendControllerChange(change);
  }
  if (bpr.ctension_ch2 != -1)
  {
    ControlChange change = new ControlChange(0, 10, bpr.ctension_ch2/2);
    myBus.sendControllerChange(change);
  }
}
